...
* :package: **[Download Latest Release (v1.5.1)](https://github.com/djacidfx/webtoapp-releases/releases/latest)**
...
Comprehensive internal feature checklist and capability tracker reflecting all features, architectures, export platforms, and security controls through **v1.5.1**:
...
- [x] **Integrated Splash Studio & Visual Brand Builder (v1.5.1)**:
...
2. Download the distribution ZIP: `WebToApp-Studio-v1.5.1.zip`.
...
|---|---|:---:|:---:|
| **`WebToApp-Studio-v1.5.1.zip`**<br><sub>`0d8731708978b2bfb204f7e8f24f07d875369913bb100956d89fbeb6f982d720`</sub> | Windows Standalone (Zero-Config Zip) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/0d8731708978b2bfb204f7e8f24f07d875369913bb100956d89fbeb6f982d720) |
| **`WebToApp-Studio-v1.5.1-Lightweight.zip`**<br><sub>`8e2d96a1ed46e6bcca72b43ff64957b5c44add6a127494abdc5f96e137aa1c9b`</sub> | Windows Lightweight (Requires .NET 8) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/8e2d96a1ed46e6bcca72b43ff64957b5c44add6a127494abdc5f96e137aa1c9b) |
| **`WebToApp-Studio-Pro_1.5.0_amd64.deb`**<br><sub>`42d1ab7b7f90bf53435596930eb27f9b04ccf7f72e485bf77f1d1d3321edf74e`</sub> | Ubuntu / Debian (.deb) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/42d1ab7b7f90bf53435596930eb27f9b04ccf7f72e485bf77f1d1d3321edf74e) |
| **`WebToApp-Studio-Pro-Linux-x64-v1.5.1-Portable.tar.gz`**<br><sub>`e6f2c043146dd904746e2d8e388dd517ee1a94a8703c2ee6e7d0932bd3d60160`</sub> | Linux x64 (.tar.gz) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/e6f2c043146dd904746e2d8e388dd517ee1a94a8703c2ee6e7d0932bd3d60160) |
...
* **:sparkles: Standalone Edition (`WebToApp-Studio-v1.5.1.zip`) [Recommended]**:  
...
* **:feather: Lightweight Edition (`WebToApp-Studio-v1.5.1-Lightweight.zip`)**:  
...
> 2. **Alternatively**, download the **Standalone Edition** (`WebToApp-Studio-v1.5.1.zip`), which has zero prerequisites and works out of the box!
