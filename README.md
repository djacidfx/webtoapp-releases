...
* :package: **[Download Latest Release (v1.5.8)](https://github.com/djacidfx/webtoapp-releases/releases/latest)**
...
Comprehensive internal feature checklist and capability tracker reflecting all features, architectures, export platforms, and security controls through **v1.5.8**:
...
- [x] **Integrated Splash Studio & Visual Brand Builder (v1.5.3)**:
  ...
  - [x] **Startup Indicators**: Choice of animated loading bar, accent spinning ring, pulsing dots, or clean minimal presentation with custom brand accent colors.
  - [x] **Artwork Fitter Mode**: High-resolution image/banner fitter with `Cover`, `Contain`, and `Stretch` aspect ratio options plus matte background color.
  - [x] **High-DPI Retina Master Canvas**: 960 × 640 (2x Retina) master canvas outputting pixel-perfect 480 × 320 px 24-bit PNG.
...
2. Download the distribution ZIP: `WebToApp-Studio-v1.5.8.zip`.
...
|---|---|:---:|:---:|
| **`WebToApp-Studio-v1.5.8.zip`**<br><sub>`8834592d52c465024408e4c1f15e751402f30e0b67dbd7ea4e98219909285bab`</sub> | Windows Standalone (Zero-Config Zip) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/8834592d52c465024408e4c1f15e751402f30e0b67dbd7ea4e98219909285bab) |
| **`WebToApp-Studio-v1.5.8-Lightweight.zip`**<br><sub>`648b5a8ab4bb3fbd37ed63fa99fa2066d7d34d5e7773ea9ad5ad63e5fb6bf187`</sub> | Windows Lightweight (Requires .NET 8) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/648b5a8ab4bb3fbd37ed63fa99fa2066d7d34d5e7773ea9ad5ad63e5fb6bf187) |
| **`WebToApp-Studio-Pro_1.5.8_amd64.deb`**<br><sub>`62638ae90c0e4dced64dbb526b41a3f5179df43b3b1b97cdb467356c0cd6b21b`</sub> | Ubuntu / Debian (.deb) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/62638ae90c0e4dced64dbb526b41a3f5179df43b3b1b97cdb467356c0cd6b21b) |
| **`WebToApp-Studio-Pro-Linux-x64-v1.5.8-Portable.tar.gz`**<br><sub>`03e67110c47fa88fb597f38d23591732c17113127ab1319c6f92313671d8df4e`</sub> | Linux x64 (.tar.gz) | :white_check_mark: Clean | [Inspect 70+ Engines &rarr;](https://www.virustotal.com/gui/file/03e67110c47fa88fb597f38d23591732c17113127ab1319c6f92313671d8df4e) |
...
* **:sparkles: Standalone Edition (`WebToApp-Studio-v1.5.8.zip`) [Recommended]**:  
...
* **:feather: Lightweight Edition (`WebToApp-Studio-v1.5.8-Lightweight.zip`)**:  
  ...
  * **Web Engine**: Microsoft Edge WebView2 Evergreen Runtime (standard on modern Windows).
...
> 2. **Alternatively**, download the **Standalone Edition** (`WebToApp-Studio-v1.5.8.zip`), which has zero prerequisites and works out of the box with no installations!
...
* When submitting bugs, please include:
  * Your version number (e.g. `v1.5.8`)
  * Windows OS version
